...
<head>
    ...
    <link rel="stylesheet" href="src/style/index_copy_style.css">
...
<div id="main_container">
    ...
    <div class="modal fade" id="exampleModal3" data-bs-backdrop="static" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="false" style=" overflow:hidden;">
        <div class="modal-dialog modal-lg" style=" overflow:hidden;">
            <div class="modal-content">
                ...
                <div id="form_modal_2" class="modal-body" style="justify-content: center; align-items: center; display:flex; flex-direction:column; overflow:hidden; ">
                    <div id="request_form_requester_form">
                        ...
                        <div class="container d-flex justify-content-center align-items-start">
                            ...
                            <div class="progresses">
                                                ...
                                                <div class="steps">
                                                <span class="font-weight-bold"><i class="fa fa-check"></i></span>
                                                </div>
                            ...
                            <div id="email_address_container">
                                <div class="label_cont">
                                    <label><span style="color: white;">*</span> Email Address</label>
                                </div>
                                <div class="textbox_cont">
                                    <input name="email" id="email_address" class="full_name_textboxes" type="text" placeholder="example@gmail.com">
                                </div>

                                <div id="invalid_email" class="error_message_container">
                            ...
                            <div id="pat_valid_id_container" class="full_name2">
                                <div class="label_cont">
                                ...
                                <div id="file_error" class="error_message_container" style="width: 96%; ">

                                    <label>File size exceeds 5MB limit.</label>
                        ...
                        <div id="requester_form">
                            ...
                            <div class="full_name">
                                ...
                                <div class="textbox_cont">
                                    <input id="requester_last_name" name="requester_last_name" class="full_name_textboxes" type="text" placeholder="Last Name" required>
                                </div>
                            </div>
                            <div class="full_name">
                                <div class="label_cont">
                            ...
                            <div class="full_name">
                                ...
                                <div class="textbox_cont">
                                    <input name="birthdate" id="requester_email_address" class="full_name_textboxes" type="text" placeholder="example@gmail.com">
                                </div>
                            </div>
                            <div class="full_name">
                                <div class="label_cont">
                                ...
                                <div class="textbox_cont">
                                    <input name="birthdate" id="requester_mobile_number" class="full_name_textboxes" type="text" placeholder="09123456789">
                                </div>
                            </div>
                            <div class="full_name">
                                <div class="label_cont">
                            ...
                            <div id="requester_valid_id_cont" class="full_name">
                                <div class="label_cont">
                            ...
                            <div id="submit_cont">
                                <button type="submit" id="submit_but" data-bs-toggle="modal" data-bs-target="#exampleModal2">Submit</button>
                            </div>
                            </form>
                        </div>
                    </div>
    ...
    <div class="modal fade" id="exampleModal2" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" >
        ...
        <div id="wrong_code_cont">

            <i class="fa-solid fa-circle-xmark" style="color: #d81313; font-size: 1.2rem; margin-left:5%;" ></i>
            <label style="font-size: 10pt; margin-right:5%">  It seems like the OTP code you entered is incorrect. Please try again </label>
                ...
                <div class="modal-body">
                    <div id="otp_container">
                        ...
                        <div id="timer_otp_res_cont">
                            ...
                            <label id="resend_otp" disabled>Resend code</label>
